...
{
    internal struct GönderenSMTPBilgisi
    {
        ...
        public GönderenSMTPBilgisi(string sunucu, string port,
                                string adres, string parola)
        {
            SUNUCU = sunucu; PORT = port; ADRES = adres;
            KULLANICI_ADI = adres.Split('@')[0];
            PAROLA = parola;
        }
    ...
    internal struct GönderenIMAPBilgisi
    {
        public string SUNUCU,
                    PORT,
                    ADRES,
        ...
        public GönderenIMAPBilgisi(string sunucu, string port,
                                string adres, string parola)
        {
            SUNUCU = sunucu; PORT = port; ADRES = adres;
            KULLANICI_ADI = adres.Split('@')[0];
        ...
        public void AyarBelgesiniOku()
        {
            string[] belge_içeriği = File.ReadAllLines("./.Ayarlar/ep2");
